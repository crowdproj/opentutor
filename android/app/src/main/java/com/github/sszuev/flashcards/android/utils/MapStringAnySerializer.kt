...
object MapStringAnySerializer : KSerializer<Map<String, Any>> {
    private val jsonMapDelegateSerializer =
        MapSerializer(String.serializer(), JsonAnyPrimitiveSerializer)
    private val cborMapDelegateSerializer =
        MapSerializer(String.serializer(), PolymorphicSerializer(Any::class))
