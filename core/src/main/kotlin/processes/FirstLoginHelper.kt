...
private val RESOURCE_DOCUMENTS_BY_LANGUAGE = mapOf(
    ...
    "hi" to listOf("/irregular-verbs-en-hi.json"),
    "ar" to listOf("/irregular-verbs-en-ar.json"),
    "bn" to listOf("/irregular-verbs-en-bn.json"),
    "pa" to listOf("/irregular-verbs-en-pa.json"),
)
