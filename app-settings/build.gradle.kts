...
application {
    mainClass.set("com.gitlab.sszuev.flashcards.settings.SettingsServerMainKt")
}
...
tasks.dockerCreateDockerfile {
    arg("SETTINGS_SERVER_NATS_HOST")
    arg("DB_PG_URL")
    arg("DB_PG_USER")
    arg("DB_PG_PWD")
    environmentVariable("SETTINGS_SERVER_NATS_HOST", "\${SETTINGS_SERVER_NATS_HOST}")
...
docker {
    val imageName = "sszuev/open-tutor-settings-server"
